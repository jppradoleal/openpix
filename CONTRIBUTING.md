# Contributing to the Open Pix Python SDK

Thank you for your interest in contributing to the Open Pix Python SDK!

## How to contribute

In order to contribute to the Open Pix Python SDK effectively we provide guidelines to address common case for contributions. Presently we have guides for the following type of changes.
...
* Bug Reports: These are reports of non compliant behavior with the SDK specification and other blatantly wrong behavior of the Open Pix Python SDK.
...
Opening an issue is as easy as following [this link](https://github.com/jppradoleal/openpix/issues/new) and filling out the given template.
